...
public class ShiroUtils {
    ...
    public static boolean validateUser(String userPassword,String dbPassword,String userSlat){

        if(StringUtils.isBlank(dbPassword)){
            return false;
        }
        if(md5(userPassword, userSlat).equals(dbPassword)){
            return true;
        }
        return false;
    }
    ...
    public static User getUser() {
        if (isGuest()) {
            ...
            getSubject().getPrincipals().getPrimaryPrincipal();
